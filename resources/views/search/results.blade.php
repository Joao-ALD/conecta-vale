<x-layouts.public>
    <x-slot name="title">Resultados para '{{ $query }}' - Conecta Vale</x-slot>
                    ...
                    @foreach($categories as $cat)
                        <li>
                            <a href="{{ route('categories.show', $cat) }}"
                                class="block px-3 py-2 rounded-md text-gray-700 hover:bg-gray-200 hover:text-vale-primary">
                                {{ $cat->name }}
                            </a>
                        </li>
                    @endforeach
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                @empty
                    <p class="text-gray-600 col-span-full">
                        Nenhum produto encontrado para sua busca. Tente um termo diferente.
                    </p>
                @endforelse
            </div>
