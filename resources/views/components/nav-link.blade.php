...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-vale-accent text-sm font-medium leading-5 text-vale-accent focus:outline-none focus:border-yellow-600 transition duration-150 ease-in-out'
