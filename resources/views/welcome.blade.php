...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Conecta Vale - O seu marketplace do Vale do Ribeira</title>
                    ...
                    <div class="flex items-center">
                        ...
                        @auth
                            @if(auth()->user()->role == 'vendedor')
                                <a href="{{ route('seller.products') }}" class="ml-4 px-3 py-2 rounded-md text-sm font-medium bg-vale-accent text-black hover:bg-yellow-600">Meus Anúncios</a>
                            @endif
                        @endauth
                    </div>
                </div>
