                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('seller.profile.update') }}" method="POST">
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-vale-primary border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-vale-accent transition ease-in-out duration-150">
                                Atualizar Perfil
                            </button>
                        </div>
                    </form>
